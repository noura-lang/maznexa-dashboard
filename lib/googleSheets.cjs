// CommonJS (.cjs) — see firebaseAdmin.cjs for why (keeps this module and
// firebase-admin's/googleapis's dependency graphs in one consistent module
// system on Vercel, where the project's package.json has "type": "module").
