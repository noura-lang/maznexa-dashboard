...
export const ACCESS_SHEET_ID = process.env.VITE_ACCESS_SHEET_ID
export const AM_SHEET_ID = process.env.VITE_AM_SHEET_ID
export const COST_SHEET_ID = process.env.VITE_COST_SHEET_ID
...
export async function fetchNamedRows(sheets, spreadsheetId, tabName) {
...
// "Dream Targets").
export async function fetchRawValues(sheets, spreadsheetId, tabName) {
  const res = await sheets.spreadsheets.values.get({ spreadsheetId, range: tabName })
